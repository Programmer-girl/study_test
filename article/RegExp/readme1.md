...
<img width="350" src="../img/image-20191119191300392.png">
...
一个用来把一个字符串拆分成多个子串的String方法

## 6.search

一个用来测试在某给定字符串里是否存在着一个匹配的String方法
...
<img src="../img/reg1.png" alt="运行结果" width="350" />

<img src="../img/reg2.png" alt="运行结果" width="350" />
...
<img width="350" src="../img/reg4.png">
...
**向前查找向后查找匹配本身其实都是有返回结果的，只是这个结果的字节长度永远是0而已，因此，前后查找操作也被称为零宽度匹配操作。**

### 向后查找 `?<=`

和向前查找类似，js不支持这里不深入了，感兴趣可查看《正则表达式必知必会9.3》

### 负向前查找、负向后查找

<img src="../img/image-20191120111549103.png" width="350">

<img src="../img/image-20191120111601578.png" width="350">

## 8. 嵌入条件

<img src="../img/image-20191120113244501.png" alt="image-20191120113244501" width=350 />
...
<img src="../img/image-20191120114009282.png" alt="image-20191120114009282" width="350" />
...
<img src="../img/image-20191120114220511.png" alt="image-20191120114220511" width="350" />
